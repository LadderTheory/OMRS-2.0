                ...
                <div className="card-body">
                    ...
                    <form ref={form} onSubmit={addParameter}> 
                        <div className="form-group">
                            ...
                            <input id="NewParameterName" autofill="off" autoComplete="off" type="text" id="name" name="name" className="form-control" onChange={changeInput} required pattern="[A-Za-z0-9- ]{1,}" title="This field should contain only uppercase letters, lowercase letter, numbers, dashes, or spaces."/>
                            <br />
