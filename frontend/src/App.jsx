...
function App(props) {
  ...
  useEffect(() => {
    ...
    keycloak.init({ onLoad: 'login-required', redirectUri: 'http://192.168.1.78:30421/' }).then(authenticated => {
  ...
  const logOut = () => {
    localStorage.clear()
    keycloak.keycloak.logout({ redirectUri: 'http://192.168.1.78:30421/' })
  }
